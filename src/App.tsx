...
const CallcenterAdvanced = lazy(() => import("@/pages/CallcenterAdvanced"));
...
const SalespersonDrilldown = lazy(() => import("@/pages/sales/SalespersonDrilldown"));
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  >
                    ...
                    <Route path="/sales/performance-sheet/:userId" element={<RoleGuard allowedRoles={['admin', 'ceo', 'responsabile_venditori', 'amministrazione']}><SalespersonDrilldown /></RoleGuard>} />
                    ...
                    <Route path="/callcenter/advanced" element={<RoleGuard allowedRoles={['admin', 'ceo', 'responsabile_callcenter']}><CallcenterAdvanced /></RoleGuard>} />
