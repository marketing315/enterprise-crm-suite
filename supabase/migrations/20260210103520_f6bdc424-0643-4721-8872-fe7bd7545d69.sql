...
-- Update lead_event_source in queue_capi_lead_event function
...
DECLARE
  ...
  v_lead_id text;
BEGIN
  -- Find active meta_app with CAPI enabled for this brand
  ...
  -- Try to get lead_id from meta_lead_events
...
-- Update lead_event_source in queue_capi_purchase_event function
