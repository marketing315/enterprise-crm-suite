-- Revert HTTP allowlist: HTTPS-only for webhook URLs (no localhost/127.0.0.1 exceptions)
...
BEGIN
  ...
  -- Validate URL: HTTPS required, no exceptions
...
BEGIN
  ...
  -- Validate URL if provided: HTTPS required, no exceptions
