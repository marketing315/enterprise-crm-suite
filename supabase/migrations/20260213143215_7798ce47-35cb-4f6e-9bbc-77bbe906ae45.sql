...
-- Update get_marketing_channel_kpis to only show channels with actual data (spend > 0 OR leads > 0)
...
BEGIN
  ...
  SELECT * FROM final_data f
  WHERE f.marketing_cost > 0 OR f.leads_count > 0 OR f.deals_won > 0
